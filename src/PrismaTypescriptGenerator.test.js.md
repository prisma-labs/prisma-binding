...
> Snapshot 1
    ...
    export interface Subscription {␊
        post: <T = PostSubscriptionPayload | null>(args: { where?: PostSubscriptionWhereInput }, info?: GraphQLResolveInfo | string, context?: { [key: string]: any }) => AsyncIterator<T> ,␊
        user: <T = UserSubscriptionPayload | null>(args: { where?: UserSubscriptionWhereInput }, info?: GraphQLResolveInfo | string, context?: { [key: string]: any }) => AsyncIterator<T> ␊
      }␊
    ␊
